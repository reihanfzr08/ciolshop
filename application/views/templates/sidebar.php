  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('welcome'); ?>">
        ...
        <div class="sidebar-brand-text mx-2">COBAIN STORE</div>
      </a>
...
-->
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('kategori/GitardanBass');?>">
          <i class="fas fa-fw fa-music"></i>
          <span>Gitar dan Bass</span></a>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('kategori/Piano');?>">
          <i class="fas fa-fw fa-keyboard"></i>
          <span>Piano</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url('kategori/Biola');?>">
