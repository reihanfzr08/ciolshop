        ...
        <form action="<?php echo base_url() . 'admin/data_barang/update'; ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control" name="kategori">
                    <option <?php if ($brg->kategori == 'Gitar dan Bass') echo 'selected'; ?>> Gitar dan Bass</option>
                    <option <?php if ($brg->kategori == 'Drum') echo 'selected'; ?>> Drum</option>
                    <option <?php if ($brg->kategori == 'Piano') echo 'selected'; ?>> Piano</option>
                    <option <?php if ($brg->kategori == 'Biola') echo 'selected'; ?>> Biola</option>
